...
apt-get update && apt-get -y install php7.0-zip php7.0-mbstring php7.0-sqlite3 php7.0-xml php7.0-imap && sed -i 's/AllowOverride FileInfo/AllowOverride All/' /etc/apache2/sites-available/000-default.conf
